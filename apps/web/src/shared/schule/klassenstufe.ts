...
export const istKlassenstufe = (wert: string): wert is Klassenstufe =>
  (klassenstufen as ReadonlyArray<string>).includes(wert);

/** In der Kursstufe zählen Notenpunkte, davor Noten von 1 bis 6. */
export const notensystemFuerKlassenstufe = (
  klassenstufe: Klassenstufe,
): Notensystem =>
  klassenstufe === 'J1' || klassenstufe === 'J2' ? 'punkte' : 'sechser';

/** Anzeigename eines Halbjahrs, z. B. "10.2" oder "J1.1". */
export const halbjahrBezeichnung = (halbjahr: {
...
export const naechsteKlassenstufe = (
  klassenstufe: Klassenstufe,
): Klassenstufe | null =>
